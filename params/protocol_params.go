...
var (
	...
	GenesisDifficulty      = big.NewInt(15_002_317) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(5_002_317)  // The minimum that the difficulty may ever be.
